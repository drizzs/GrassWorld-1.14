...
import net.minecraftforge.api.distmarker.OnlyIn;
 ...
 @OnlyIn(Dist.CLIENT)
public abstract class GWParticle extends TexturedParticle implements IParticleRenderType {

        protected GWParticle(World world, double x, double y, double z) {
            super(world, x, y, z);
        }

        protected GWParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
