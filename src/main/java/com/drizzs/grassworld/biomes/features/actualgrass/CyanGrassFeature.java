...
public class CyanGrassFeature extends Feature<NoFeatureConfig>
{
    public CyanGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_cyan.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
