...
public class LightGreyGrassFeature extends Feature<NoFeatureConfig>
{
    public LightGreyGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_lightgrey.getDefaultState() : GrassWorldBlocks.actualgrass_grey.getDefaultState();
    }
