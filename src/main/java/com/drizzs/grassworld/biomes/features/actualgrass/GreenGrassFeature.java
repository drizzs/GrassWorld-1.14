...
public class GreenGrassFeature extends Feature<NoFeatureConfig>
{
    public GreenGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_green.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
