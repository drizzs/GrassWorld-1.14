...
public class YellowGrassFeature extends Feature<NoFeatureConfig>
{
    public YellowGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_yellow.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
