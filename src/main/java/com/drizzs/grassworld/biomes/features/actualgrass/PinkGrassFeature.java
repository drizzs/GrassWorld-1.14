...
public class PinkGrassFeature extends Feature<NoFeatureConfig>
{
    public PinkGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_pink.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
