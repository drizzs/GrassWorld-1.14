...
public class BlueGrassFeature extends Feature<NoFeatureConfig>
{
    public BlueGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_blue.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
