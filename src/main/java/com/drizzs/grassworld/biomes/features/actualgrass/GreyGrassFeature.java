...
public class GreyGrassFeature extends Feature<NoFeatureConfig>
{
    public GreyGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_grey.getDefaultState() : GrassWorldBlocks.actualgrass_white.getDefaultState();
    }
