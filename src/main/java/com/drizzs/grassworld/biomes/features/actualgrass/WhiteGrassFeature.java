...
public class WhiteGrassFeature extends Feature<NoFeatureConfig>
{
    public WhiteGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_white.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
