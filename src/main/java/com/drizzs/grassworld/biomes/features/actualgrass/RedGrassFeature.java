...
public class RedGrassFeature extends Feature<NoFeatureConfig>
{
    public RedGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_red.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
