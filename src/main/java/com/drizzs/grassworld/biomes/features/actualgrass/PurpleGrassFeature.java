...
public class PurpleGrassFeature extends Feature<NoFeatureConfig>
{
    public PurpleGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_purple.getDefaultState() : GrassWorldBlocks.actualgrass_red.getDefaultState();
    }
