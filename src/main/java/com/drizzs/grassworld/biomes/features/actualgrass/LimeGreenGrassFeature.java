...
public class LimeGreenGrassFeature extends Feature<NoFeatureConfig>
{
    public LimeGreenGrassFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> deserializer)
    {
        super(deserializer);
    }
    ...
    {
        return rand.nextInt(3) == 0 ? GrassWorldBlocks.actualgrass_green.getDefaultState() : GrassWorldBlocks.actualgrass_orange.getDefaultState();
    }
