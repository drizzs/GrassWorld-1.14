...
public class OrangeEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public OrangeEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.ORANGEEND);
        } else {
