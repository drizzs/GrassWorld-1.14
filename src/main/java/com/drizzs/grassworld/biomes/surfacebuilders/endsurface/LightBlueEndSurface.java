...
public class LightBlueEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public LightBlueEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.LIGHTBLUEEND);
        } else {
