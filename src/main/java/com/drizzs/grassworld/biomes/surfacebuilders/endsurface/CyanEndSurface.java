...
public class CyanEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public CyanEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.CYANEND);
        } else {
