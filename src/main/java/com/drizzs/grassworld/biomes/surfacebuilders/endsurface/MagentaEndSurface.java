...
public class MagentaEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public MagentaEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.MAGENTAEND);
        } else {
