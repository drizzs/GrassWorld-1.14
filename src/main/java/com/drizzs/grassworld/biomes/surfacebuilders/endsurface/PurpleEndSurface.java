...
public class PurpleEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public PurpleEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.PURPLEEND);
        } else {
