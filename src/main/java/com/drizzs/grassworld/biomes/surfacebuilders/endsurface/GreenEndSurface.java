...
public class GreenEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public GreenEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.GREENEND);
        } else {
