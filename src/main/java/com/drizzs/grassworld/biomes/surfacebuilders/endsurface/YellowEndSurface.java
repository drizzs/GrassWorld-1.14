...
public class YellowEndSurface extends SurfaceBuilder<SurfaceBuilderConfig>
{
    public YellowEndSurface()
    {
    ...
    {
        if (noise > 1.9D) {
            SurfaceBuilder.DEFAULT.buildSurface(random, chunkIn, biomeIn, x, z, startHeight, noise, defaultBlock, defaultFluid, seaLevel, seed, GrassSurfaces.YELLOWEND);
        } else {
