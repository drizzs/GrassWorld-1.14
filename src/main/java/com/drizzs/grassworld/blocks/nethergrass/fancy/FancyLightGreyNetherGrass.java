package com.drizzs.grassworld.blocks.nethergrass.fancy;
...
public class FancyLightGreyNetherGrass extends NetherGrassBase
{

    public FancyLightGreyNetherGrass(Properties p_i48388_1_) {
        super(p_i48388_1_);
    }

    public void grow(World worldIn, Random rand, BlockPos pos, BlockState state) {
        BlockPos blockpos = pos.up();
        BlockState blockstate = GrassWorldBlocks.actualgrass_lightgrey.getDefaultState();
