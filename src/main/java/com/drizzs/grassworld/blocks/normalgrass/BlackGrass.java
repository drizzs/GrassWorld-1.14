...
public class BlackGrass extends GrassBlock {

    public BlackGrass(Properties p_i48388_1_) {
        super(p_i48388_1_);
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public void tick(World world, BlockPos pos, IFluidState p_204522_3_, Random random) {
        BlockPos blockpos = pos.up();
