package com.drizzs.grassworld.blocks.glowinggrass;
...
public class GlowingLightGreyGrass extends GrassBlock
{

    public GlowingLightGreyGrass(Properties properties) {
        super(properties);
    }
