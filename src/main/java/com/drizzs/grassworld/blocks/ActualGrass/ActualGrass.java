...
public class ActualGrass extends TallGrassBlock {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.GRASS_BLOCK || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND
                ...
                || block == GrassWorldBlocks.fancy_brown_grass || block == GrassWorldBlocks.enchanted_brown_grass || block == GrassWorldBlocks.brown_grass
                || block == GrassWorldBlocks.brownendgrass || block == GrassWorldBlocks.brownnethergrass || block == GrassWorldBlocks.fancybrownendgrass
                || block == GrassWorldBlocks.fancybrownnethergrass
