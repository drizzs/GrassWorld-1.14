...
public class GreenEndermanEntity extends MonsterEntity {
    ...
    private static final DataParameter<Optional<BlockState>> CARRIED_BLOCK = EntityDataManager.createKey(GreenEndermanEntity.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager.createKey(GreenEndermanEntity.class, DataSerializers.BOOLEAN);
    ...
    public GreenEndermanEntity(EntityType<? extends MonsterEntity> entity, World world) {
        super(entity, world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new GreenEndermanEntity.StareGoal(this));
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.0D, false));
        this.goalSelector.addGoal(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 0.0F));
        this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, 8.0F));
        this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
        this.goalSelector.addGoal(10, new GreenEndermanEntity.PlaceBlockGoal(this));
        this.goalSelector.addGoal(11, new GreenEndermanEntity.TakeBlockGoal(this));
        this.targetSelector.addGoal(1, new GreenEndermanEntity.FindPlayerGoal(this));
    ...
    static class FindPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
        private final GreenEndermanEntity enderman;
        ...
        public FindPlayerGoal(GreenEndermanEntity p_i45842_1_) {
    ...
    static class PlaceBlockGoal extends Goal {
        ...
        public PlaceBlockGoal(GreenEndermanEntity p_i45843_1_) {
    ...
    static class StareGoal extends Goal {
        private final GreenEndermanEntity field_220835_a;

        public StareGoal(GreenEndermanEntity p_i50520_1_) {
    ...
    static class TakeBlockGoal extends Goal {
        ...
        public TakeBlockGoal(GreenEndermanEntity p_i45841_1_) {
