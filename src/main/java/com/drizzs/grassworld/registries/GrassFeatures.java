    ...
    public static void onFeatureRegistryEvent(RegistryEvent.Register<Feature<?>> event) {
        if (GrassConfigHandler.COMMON.GRASSFEATURE.get()) {
            if (GrassConfigHandler.COMMON.BLACKGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.BLACKGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.BLACKGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.BLUEGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.BLUEGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.BLUEGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.GREYGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.GREYGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.GREYGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.MAGENTAGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.MAGENTAGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.MAGENTAGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.CYANGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.CYANGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.CYANGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.ORANGEGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.ORANGEGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.ORANGEGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.BROWNGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.BROWNGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.BROWNGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.GREENGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.GREENGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.GREENGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.REDGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.REDGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.REDGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.PURPLEGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.PURPLEGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.PURPLEGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.PINKGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.PINKGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.PINKGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.WHITEGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.WHITEGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.WHITEGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.YELLOWGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.YELLOWGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.YELLOWGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.LIMEGREENGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.LIMEGREENGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.LIMEGREENGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.LIGHTGREYGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.LIGHTGREYGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.LIGHTGREYGRASSFEATUREWEIGHT.get()))));
            } else if (GrassConfigHandler.COMMON.LIGHTBLUEGRASSFEATURE.get()) {
                ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(GrassFeatureLib.LIGHTBLUEGRASS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(GrassConfigHandler.COMMON.LIGHTBLUEGRASSFEATUREWEIGHT.get()))));
            }

            if(GrassConfigHandler.COMMON.ISLANDFEATURE.get()){
                if(GrassConfigHandler.COMMON.BLACKISLANDFEATURE.get()) {
                    ForgeRegistries.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.RAW_GENERATION, createDecoratedFeature(GrassFeatureLib.BLACKISLANDFEATURE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.END_ISLAND, IPlacementConfig.NO_PLACEMENT_CONFIG)));
                }
