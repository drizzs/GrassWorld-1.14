...
public class GrassIslandPiece extends TemplateStructurePiece {
  ...
  public GrassIslandPiece(TemplateManager templateManager, GrassIslandVariant variant, String templateName, BlockPos templatePosition, Rotation rotation, Mirror mirror) {
    super(ISLANDPIECE, 0);
  ...
  public GrassIslandPiece(TemplateManager templateManager, CompoundNBT nbt) {
