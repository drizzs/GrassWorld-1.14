...
public class LightBlueNetherSeed extends Item {
    ...
    public LightBlueNetherSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.lightbluenetherseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.NETHERRACK)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.lightbluenethergrass.getDefaultState());
            item.shrink(1);
        }
