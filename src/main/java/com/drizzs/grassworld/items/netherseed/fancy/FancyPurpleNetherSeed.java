...
public class FancyPurpleNetherSeed extends Item {
    ...
    public FancyPurpleNetherSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancypurplenetherseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.NETHERRACK)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancypurplenethergrass.getDefaultState());
            item.shrink(1);
        }
