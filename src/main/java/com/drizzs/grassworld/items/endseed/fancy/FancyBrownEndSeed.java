...
public class FancyBrownEndSeed extends Item {
    ...
    public FancyBrownEndSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancybrownendseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.END_STONE)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancybrownendgrass.getDefaultState());
            item.shrink(1);
        }
