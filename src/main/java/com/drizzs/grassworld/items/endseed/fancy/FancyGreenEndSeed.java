...
public class FancyGreenEndSeed extends Item {
    ...
    public FancyGreenEndSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancygreenendseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.END_STONE)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancygreenendgrass.getDefaultState());
