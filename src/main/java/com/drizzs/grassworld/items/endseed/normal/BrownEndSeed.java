...
public class BrownEndSeed extends Item {
    ...
    public BrownEndSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.brownendseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.END_STONE)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.brownendgrass.getDefaultState());
