...
public class FancyLimeGreenEndSeed extends Item {
    ...
    public FancyLimeGreenEndSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancylimegreenendseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.END_STONE)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancylimegreenendgrass.getDefaultState());
