...
public class FancyWhiteEndSeed extends Item {
    ...
    public FancyWhiteEndSeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancywhiteendseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.END_STONE)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancywhiteendgrass.getDefaultState());
            item.shrink(1);
        }
