package com.drizzs.grassworld.items.fancyseed;
...
public class FancyLightGreySeed extends Item {

    public FancyLightGreySeed(Properties group)
    {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (!(item.getItem() == GrassWorldItems.fancy_lightgreyseed)){
        ...
        if (world.getBlockState(blockpos).getBlock() == Blocks.GRASS_BLOCK || world.getBlockState(blockpos).getBlock() == Blocks.DIRT)
        {
            ...
            world.setBlockState(blockpos, GrassWorldBlocks.fancy_lightgrey_grass.getDefaultState());
            item.shrink(1);
        }
